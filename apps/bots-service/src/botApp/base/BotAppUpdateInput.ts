...
class BotAppUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OpenAppUpdateManyWithoutBotAppsInput,
  })
  @ValidateNested()
  @Type(() => OpenAppUpdateManyWithoutBotAppsInput)
  @IsOptional()
  @Field(() => OpenAppUpdateManyWithoutBotAppsInput, {
    nullable: true,
  })
...
export { BotAppUpdateInput as BotAppUpdateInput };
